...
const baseURL: string = "https://chames.youssef.tn";
...
// Import and set font for each variant with fallbacks
...
const sameAs: SameAsConfig = {
  ...
  discord: "",
  x: "https://x.com/ChamesDhibi",
  github: "https://github.com/Chams99",
};
