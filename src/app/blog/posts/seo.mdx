...
The portfolio automatically generates meta- and open graph tags for your pages based on the `content.tsx` file.

## Schema

The portfolio automatically generates schema tags for your pages based on the `content.tsx` file.
